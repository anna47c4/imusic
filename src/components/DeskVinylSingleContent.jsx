...
function DeskVinylSingleContent(...props) {
  return (
    <>
      ...
      <div className="right-side-wrapper">
        <div className="info-txt-shown">
          ...
          <div className="wrapper">
            <h2>{props.kunstner}</h2>
            {props.farve && <p>{props.farve}</p>}
          </div>
          {props.edition && (
          ...
          <div className="pris">
            ...
            <p className="vinyl-pris">DKK {props.pris}</p>
...
export default DeskVinylSingleContent;
